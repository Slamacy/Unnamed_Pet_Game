...
public class MainApp {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 2: 
                    ...
                    break;
                case 3:
                    petMenu(); //access pet menu - allows for interactin with pet
                    break;
                case 4: 
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.println(pet.toString()); //Testing purposes
                    break;
                case 2:
    ...
    public static void save() throws FileNotFoundException, IOException {
        ...
        saveData.write("\n" + pet.getName());               //the following lines write the pet's attributes/stats to a txt file
        saveData.write("\n" + pet.getSpecies());
        saveData.write("\n" + pet.getGender());
        saveData.write("\n" + pet.getHunger());
        saveData.write("\n" + pet.getHappiness());
    ...
    public static void readSave() throws FileNotFoundException, IOException {
        ...
        money = reader.nextFloat(); //sets money to previous quantity
        menu();
    }
